	...
	public static void main(String[] argument) {
		...
		do {
			...
			case '/':
				...
				break;
			case '*':
				System.out.println("Le resultat est PLUS " + (entier1 * entier2));
				break;
			default:
				System.out.println("Saisissez a nouveau l'opérateur");
			}
		} while (operateur != MOINS && operateur != PLUS && operateur != DIVISE && operateur != MULTIPLIE); // condition
																											// de
																											// sortie
																											// de
																											// la
