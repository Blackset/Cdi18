// class : Calculette
// Ce programme est une calculette simple. On saisit 2 nombres et un opérateur et on renvoie le résultat.
...
public class Calculette {
	...
	public static void main(String[] args) {		
		...
		// Lecture de l'opérateur, le controle de validité à lieu lors du calcul ultérieur
		...
		switch (operateur)
		{
			...
			case '/' :
				if (nombre2 == 0 && operateur == '/')		// Test de la division par 0
				{
			...
			default :		// aucun des opérateurs valides n'a été trouvé
				System.out.println ("Erreur, votre opérateur est invalide.");
				System.out.println ("");
				result = 0 ;
		}
