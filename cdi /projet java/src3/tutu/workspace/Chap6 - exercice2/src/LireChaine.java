...
public class LireChaine
{
	public static void lireChaine(char [] leTableau, int tailleTab, char CarStop)
	{
		...
		// LeTabeau est maintenant renseigné avec la chaine utilisateur.
	...
	{
		// Cette procédure affiche une chaine terminée par un caractère carStop sous forme d'un tableau.
		// Entrée leTableau : le tableau que l'on doit afficher.
		// Entrée tailleTab : la taille totale allouée du tableau.
	...
	public static void afficherPhrase(char [] leTableau, int tailleTab, char carStop)
	{
		// Cette procédure affiche une phrase terminée par un caractère carStop.
		// Entrée leTableau : le tableau que l'on doit afficher.
		// Entrée tailleTab : la taille totale allouée du tableau.
		// entrée CarStop : le caractère terminateur de la phrase
