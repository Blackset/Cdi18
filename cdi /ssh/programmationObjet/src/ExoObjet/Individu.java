...
public class Individu
{
	...
	public Individu (String nom, String prénom, String adresse)
	{
		if (!setNom(nom));         m_strNom =(nom); 
		if (!setPrénom(prénom));   m_strPrénom =(prénom);
		if (!setAdresse(adresse)); m_strAdresse =(adresse);	 	
	}

	public Individu()
	{
		m_strNom = "CRASTES"; 
		m_strPrénom = "AURELIEN";
		m_strAdresse ="5 RUE ALBERT CAMUS 69008 LYON" ;	 	
	}
